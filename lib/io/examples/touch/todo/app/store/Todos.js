...
Ext.define('MyApp.store.Todos', {
    ...
    config: {
        ...
        sorters: [
               {
                   property : 'completed', //Ensure that all completed/uncompleted tasks are displayed together and in the same order
                   direction: 'ASC'
               },
               {
                   property : 'timestamp', // then sort by creation date with newest on top
                   direction: 'DESC'
               }
        ]
